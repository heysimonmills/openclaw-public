        ...
        for calendar in calendars.get('items', []):
            ...
            for event in events_data.get('items', []):
                ...
                if 'dateTime' in start:
                    ...
                    # For all-day events, use noon UTC
                    date_str = start['date']
                    start_time = datetime.datetime.fromisoformat(f"{date_str}T12:00:00+00:00")
                ...
                # Include events starting in the next 24 hours
                if 0 <= hours_until_event <= 24:
                    # Get updated timestamp as seconds since epoch
