...
def check_emails_with_threads():
    """Check for emails with thread IDs."""
    ...
    # List emails
    url = f"https://gmail.googleapis.com/gmail/v1/users/me/messages?q={urllib.parse.quote(query)}&maxResults=20"
...
if __name__ == "__main__":
    emails = check_emails_with_threads()
